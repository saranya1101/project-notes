  ...
  return (
    ...
    >
      ...
      >
        ...
        <button
          type="submit"
          className="w-full bg-fuchsia-600 text-white px-8 py-3 rounded-full shadow-lg text-lg font-semibold hover:bg-fuchsia-700 hover:scale-105 transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-fuchsia-300"
          style={{ fontFamily: "'Times New Roman', Times, serif" }}
        >
          Create New Account
        </button>
